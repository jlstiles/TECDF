...
for (n in c(100, 250, 500, 1000, 2500, 5000)) {
  ...
  getres = function(n, t, h, k, truth, d = 1, g0, Q0, formu = NULL) {
    tmledata=gentmledata_hal(n, d = 1, g0, Q0, V = 10, RCT = FALSE)
  ...
  if (n == 5000) {
    save(res100unif13, res100unif18, res100unif23, res100unif28, 
         ...
         g0, Q0, file = "kernel_sim_unifallCVhal.RData")
...
# blip = seq(13,28,5)
# 
# testres = CATEsurv_plot(t[blip], h = bw, k = k,truth = truth_h[blip], n=1000, tmledata = test)
# testres$plot
# testres$steps
# testres$info
# 
# getres(n, t, h, k, truth, d = 1, g0, Q0) 
