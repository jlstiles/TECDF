...
# for (rr in 1:5) {
  ...
  getres = function(n, t, h, k, truth, d = 1, g0, Q0, formu = NULL) {
    ...
    reshal_simul = CATEsurv_plot(t = t, h = h, k = k, truth = truth, n = n, 
                                 tmledata = data$tmledata, fun = gentmle_alt2)
    resglm_simul = CATEsurv_plot(t = t, h = h, k = k, truth = truth, n = n, 
                                 tmledata = data$tmledata1, fun = gentmle_alt2)
    reshal = lapply(1:length(t), FUN = function(x) {
      res = CATEsurv_plot(t = t[x], h = h, k = k, truth = truth[x], n = n, 
                          tmledata = data$tmledata, fun = gentmle_alt2)
      return(res)
     })
  ...
  fname = paste0("unifCVhalglm0_",sim_abbr,rr,"_",n,".RData")
