...
for (n in c(100, 250, 500, 1000, 2500, 5000, 10000, 25000, 50000)) {
    ...
    getres = function(n, t, h, k, truth, d = 1, g0, Q0, formu = NULL) {
      data = gentmledata(n, d = 1, g0, Q0, V = 10, formu = NULL) 
      resglm_simul = CATEsurv_plot(t = t, h = h, k = k, truth = truth, n = n, tmledata = data)
      resglm = lapply(1:length(t), FUN = function(x) {
        res = CATEsurv_plot(t = t[x], h = h, k = k, truth = truth[x], n = n, tmledata = data)
        return(res)
      })
      return(list(resglm_simul = resglm_simul$info, resglm = resglm))
    }
    # tests = getres(n=100, t[blip], bw, k = k,
    ...
    fname = paste0("unifCVwell_",n,".RData")
